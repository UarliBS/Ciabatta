...
<nav class="navbar bg-body-tertiary bg-dark" data-bs-theme="dark">
    <div class="container-fluid justify-content-center">
        ...
        <a href="list_prod.php" class="btn btn-outline-light">Editar</button></a>
        <a class="navbar-brand"></a>
        <a href="../index.php" class="btn btn-outline-warning" style="color:white">Voltar</button></a>
    </div>
</nav><br>

<body>
    <div class="container">
        <h2 style="padding:20px">Adcione uma peça ao seu cardápio!</h2>
        <form class="row g-3" method="post" action="../add_banco.php" enctype="multipart/form-data">
            <div class="col-md-12">
